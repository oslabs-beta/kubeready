...
const grafanaController = {
  ...
  //     'curl -s -X POST -H "Content-Type: application/json" -H "Cookie: grafana_session=$session" -d \'{"name":"apikeycurl1", "role": "Admin"}\' http://localhost:3000/api/auth/keys > server/grafana/apitoken.json',
